...
export default function CompaniesPage() {
  ...
  return <CrmShell activePath="/companies" search={search} onSearch={setSearch}><div className="mx-auto max-w-[1500px] px-4 py-7 md:px-8 md:py-9">
    ...
    <section className="mt-7 grid gap-4 sm:grid-cols-3"><Stat icon={Building2} label="Active companies" value={active.length} /><Stat icon={UsersRound} label="Linked contacts" value={linkedContacts} /><Stat icon={Globe2} label="With websites" value={active.filter((company) => company.website).length} /></section>
