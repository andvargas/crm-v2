...
import { normalizeWebsite } from "../lib/crm";
...
export function QuickAdd() {
  ...
  const [form, setForm] = useState({ name: "", email: "", jobTitle: "", phone: "", industry: "", website: "", company: "", companyName: "", contact: "", contactName: "", type: "enquiry", channel: "email", status: "enquired", note: "", outcome: "" });
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setForm({ name: "", email: "", jobTitle: "", phone: "", industry: "", website: "", company: "", companyName: "", contact: "", contactName: "", type: "enquiry", channel: "email", status: "enquired", note: "", outcome: "" });
    },
